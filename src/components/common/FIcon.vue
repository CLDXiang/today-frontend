<template>
  ...
  <svg
    v-else-if="name==='question-circle'"
    :width="parsedWidth"
    :height="parsedHeight"
    viewBox="0 0 1024 1024"
    fill="currentColor"
  ...
  <svg
    v-else-if="name==='chat-square-quote'"
    :width="parsedWidth"
    :height="parsedHeight"
    viewBox="0 0 16 16"
    fill="currentColor"
  ...
  <svg
    v-else-if="name==='hand-thumbs-up-fill'"
    :width="parsedWidth"
    :height="parsedHeight"
    viewBox="0 0 16 16"
    fill="currentColor"
